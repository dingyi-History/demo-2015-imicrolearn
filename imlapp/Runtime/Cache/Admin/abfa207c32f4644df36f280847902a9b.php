...
<div id="loading"><img src="/imicrolearn/Public/backend/img/ajax-loader.gif"></div>
  ...
  <div class="viewport ">
    <div class="overview collapse">
      ...
      <ul id="sidebar_menu" class="navbar nav nav-list container full">
        <li class="accordion-group active color_4"> <a class="dashboard " href="index.html"><img src="/imicrolearn/Public/backend/img/menu_icons/dashboard.png"><span>Dashboard</span></a> </li>
        <li class="accordion-group color_7"> <a class="accordion-toggle widgets collapsed " data-toggle="collapse" data-parent="#sidebar_menu" href="#collapse1"> <img src="/imicrolearn/Public/backend/img/menu_icons/forms.png"><span>Form Elements</span></a>
...
<li><a href="forms_wizard.html">Wizards</a></li>
        ...
        <li class="accordion-group color_3"> <a class="accordion-toggle widgets collapsed" data-toggle="collapse" data-parent="#sidebar_menu" href="#collapse2"> <img src="/imicrolearn/Public/backend/img/menu_icons/widgets.png"><span>UI Widgets</span></a>
        ...
        <li class="color_13"> <a class="widgets" href="calendar2.html"> <img src="/imicrolearn/Public/backend/img/menu_icons/calendar.png"><span>Calendar</span></a> </li>
        <li class="color_10"> <a class="widgets"data-parent="#sidebar_menu" href="maps.html"> <img src="/imicrolearn/Public/backend/img/menu_icons/maps.png"><span>Maps</span></a> </li>
        <li class="accordion-group color_12"> <a class="accordion-toggle widgets collapsed" data-toggle="collapse" data-parent="#sidebar_menu" href="#collapse3"> <img src="/imicrolearn/Public/backend/img/menu_icons/tables.png"><span>Tables</span></a>
        ...
        <li class="accordion-group color_19"> <a class="accordion-toggle widgets collapsed" data-toggle="collapse" data-parent="#sidebar_menu" href="#collapse4"> <img src="/imicrolearn/Public/backend/img/menu_icons/statistics.png"><span>Charts</span></a>
          <ul id="collapse4" class="accordion-body collapse">
            <li><a href="statistics.html">Statistics Elements</a></li>
            <li><a href="charts.html">Charts</a></li>
          </ul>
        </li>
        <li class="color_24"> <a class="widgets"data-parent="#sidebar_menu" href="grid.html"> <img src="/imicrolearn/Public/backend/img/menu_icons/grid.png"><span>Grid</span></a> </li>
        <li class="color_8"> <a class="widgets"data-parent="#sidebar_menu" href="media.html"> <img src="/imicrolearn/Public/backend/img/menu_icons/gallery.png"><span>Media</span></a> </li>
        <li class="color_4"> <a class="widgets"data-parent="#sidebar_menu" href="file_explorer.html"> <img src="/imicrolearn/Public/backend/img/menu_icons/explorer.png"><span>File Explorer</span> <!--  --></a> </li>
        <li class="accordion-group color_25"> <a class="accordion-toggle widgets collapsed" data-toggle="collapse" data-parent="#sidebar_menu" href="#collapse5"> <img src="/imicrolearn/Public/backend/img/menu_icons/others.png"><span>Specific Pages</span></a>
          ...
          <div class="row-fluid fluid">
            ...
            <div class="span6">
              <div class=" box color_26 height_medium paint_hover">
                <div class="content icon big_icon"> <a href="#" ><img align="center" src="/imicrolearn/Public/backend/img/general/contacts_icon.png" /></a>
      ...
      <div class="row-fluid">
        <div class="row-fluid box color_2 title_medium height_medium2 bar_stats paint_hover ">
          ...
          <div class="content row-fluid fluid numbers">
            ...
            <div class="span1 stick top right result height_medium2"> <img src="/imicrolearn/Public/backend/img/arrows_up.png">
      ...
      <div class="row-fluid">
        <div class="row-fluid box color_27 title_medium height_medium2 bar_stats paint_hover">
          ...
          <div class="content row-fluid fluid numbers">
            ...
            <div class="span1 stick top right result height_medium2"> <img src="/imicrolearn/Public/backend/img/arrows_down.png">
          ...
          <div class="box color_2 ">
            ...
            <div class="content row-fluid">
              <ul class="messages_layout">
                ...
                <li class="from_user left"> <a href="#" class="avatar"><img src="/imicrolearn/Public/backend/img/message_avatar2.png"/></a>
                ...
                <li class="by_myself right"> <a href="#" class="avatar"><img src="/imicrolearn/Public/backend/img/message_avatar4.png"/></a>
                  <div class="message_wrap"> <span class="arrow"></span>
...
<script type='text/javascript'>
    ...
    <script src="/imicrolearn/Public/backend/js/jquery.js" type="text/javascript"> </script> 
<!--[if !IE]> -->
<!--[if !IE]> -->
<script src="/imicrolearn/Public/backend/js/plugins/enquire.min.js" type="text/javascript"></script> 
<!-- <![endif]-->
<!-- <![endif]-->
<!--[if lt IE 7]>
<script src="http://ie7-js.googlecode.com/svn/version/2.1(beta4)/IE7.js"></script>
<![endif]-->
<script language="javascript" type="text/javascript" src="/imicrolearn/Public/backend/js/plugins/jquery.sparkline.min.js"></script> 
<script src="/imicrolearn/Public/backend/js/plugins/excanvas.compiled.js"></script>
<script src="/imicrolearn/Public/backend/js/bootstrap-transition.js" type="text/javascript"></script> 
<script src="/imicrolearn/Public/backend/js/bootstrap-alert.js" type="text/javascript"></script> 
<script src="/imicrolearn/Public/backend/js/bootstrap-modal.js" type="text/javascript"></script> 
<script src="/imicrolearn/Public/backend/js/bootstrap-dropdown.js" type="text/javascript"></script> 
<script src="/imicrolearn/Public/backend/js/bootstrap-scrollspy.js" type="text/javascript"></script> 
<script src="/imicrolearn/Public/backend/js/bootstrap-tab.js" type="text/javascript"></script> 
<script src="/imicrolearn/Public/backend/js/bootstrap-tooltip.js" type="text/javascript"></script> 
<script src="/imicrolearn/Public/backend/js/bootstrap-popover.js" type="text/javascript"></script> 
<script src="/imicrolearn/Public/backend/js/bootstrap-button.js" type="text/javascript"></script> 
<script src="/imicrolearn/Public/backend/js/bootstrap-collapse.js" type="text/javascript"></script> 
<script src="/imicrolearn/Public/backend/js/bootstrap-carousel.js" type="text/javascript"></script> 
<script src="/imicrolearn/Public/backend/js/bootstrap-typeahead.js" type="text/javascript"></script> 
<script src="/imicrolearn/Public/backend/js/bootstrap-affix.js" type="text/javascript"></script> 
<script src="/imicrolearn/Public/backend/js/fileinput.jquery.js" type="text/javascript"></script> 
<script src="/imicrolearn/Public/backend/js/jquery-ui-1.8.23.custom.min.js" type="text/javascript"></script> 
<script src="/imicrolearn/Public/backend/js/jquery.touchdown.js" type="text/javascript"></script> 
<script language="javascript" type="text/javascript" src="/imicrolearn/Public/backend//js/plugins/jquery.uniform.min.js"></script> 
<script language="javascript" type="text/javascript" src="/imicrolearn/Public/backend//js/plugins/jquery.tinyscrollbar.min.js"></script> 
<script language="javascript" type="text/javascript" src="/imicrolearn/Public/backend//js/jnavigate.jquery.min.js"></script> 
<script language="javascript" type="text/javascript" src="/imicrolearn/Public/backend//js/jquery.touchSwipe.min.js"></script> 
<script language="javascript" type="text/javascript" src="/imicrolearn/Public/backend//js/plugins/jquery.peity.min.js"></script> 

<!-- Flot charts --> 
<script language="javascript" type="text/javascript" src="/imicrolearn/Public/backend/js/plugins/flot/jquery.flot.js"></script> 
<script language="javascript" type="text/javascript" src="/imicrolearn/Public/backend/js/plugins/flot/jquery.flot.resize.js"></script> 

<!-- Data tables --> 
<script type="text/javascript" language="javascript" src="/imicrolearn/Public/backend/js/plugins/datatables/js/jquery.dataTables.js"></script> 

<!-- Task plugin --> 
<script language="javascript" type="text/javascript" src="/imicrolearn/Public/backend/js/plugins/knockout-2.0.0.js"></script> 
